...
bool cadastrarCliente( ){
  ...
  do{ 
    ...
    if( verificaSaida(cliente.nome[0], cliente.nome[1]) ) return false;
  ...
  do{
    ...
    if( verificaSaida(cliente.cpf[0], cliente.cpf[1]) ) return false;
  ...
  do{
    ...
    if( verificaSaida(cliente.dataNascimento[0], cliente.dataNascimento[1]) ) return false;
  ...
  do{
    ...
    if( verificaSaida(cliente.sexo[0], cliente.sexo[1]) ) return false;
